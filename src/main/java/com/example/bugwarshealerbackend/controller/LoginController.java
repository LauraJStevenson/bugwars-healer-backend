...
public class LoginController {
    ...
    public ResponseEntity<AuthenticatedUser> login (@Valid @RequestBody UserLogin userlogin) {
        ...
        return ResponseEntity.ok(new AuthenticatedUser(loggedInUser.getUsername(), loggedInUser.getPassword(), loggedInUser.getFirstname(), loggedInUser.getLastname(), loggedInUser.getEmail(), jwtToken));
